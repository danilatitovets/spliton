    ...
    <div className="min-h-0 bg-white text-zinc-950 antialiased">
      <div className="sticky top-0 z-50 bg-white/95 py-3.5 shadow-[0_8px_32px_-16px_rgba(0,0,0,0.06)] backdrop-blur-md supports-backdrop-filter:bg-white/88 md:py-4">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 md:px-8">
          <span className="text-[14px] font-semibold tracking-tight text-zinc-900">Покупка units</span>
          <Link
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-[minmax(0,0.9fr)_minmax(420px,1.25fr)] md:items-start">
            <aside className="rounded-3xl bg-zinc-100/70 p-5 md:p-6">
              <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-500">О unit релиза</p>
              ...
              <p className="mt-3 max-w-md text-[14px] leading-relaxed text-zinc-600">
                1 unit - это часть права на revenue share по этому треку. Вы покупаете units именно этого релиза, не всего
                каталога.
              </p>

              <dl className="mt-6 space-y-4 text-[13px]">
                <div>
                  <dt className="text-zinc-500">Цена за 1 unit</dt>
                  <dd className="mt-0.5 font-mono text-[16px] font-semibold text-zinc-900">
                    {formatUsdtFixedRu(unitPrice)} USDT
                  </dd>
                </div>
                <div>
                  <dt className="text-zinc-500">Доступно units</dt>
                  <dd className="mt-0.5 font-mono text-[16px] font-semibold text-zinc-900">
                    {formatUnitsCompact(row.availableUnits)}
                  </dd>
                </div>
                <div>
                  <dt className="text-zinc-500">ID релиза</dt>
                  <dd className="mt-0.5 font-mono text-[16px] font-semibold text-zinc-900">{row.id}</dd>
                </div>
              </dl>
              ...
              <div className="mt-7 rounded-2xl bg-white/85 px-4 py-3.5">
                ...
                <dl className="mt-3 space-y-2.5 text-[13px]">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <dd className="font-mono font-semibold text-zinc-900">{formatUnitsCompact(maxUnits)} units</dd>
                  </div>
                  <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <dd className="font-mono font-semibold text-zinc-900">1 unit</dd>
                  </div>
                  <div className="flex items-start justify-between gap-3">
                    <dt className="text-zinc-500">Сумма покупки</dt>
                    <dd className="text-right font-mono font-semibold text-zinc-900">
                      {formatUsdtFixedRu(minOrderUsdt)} - {formatUsdtFixedRu(maxOrderUsdt)} USDT
                    </dd>
                  </div>
                </dl>
              </div>
