  ...
  return (
    ...
    >
      <div
        role="region"
        aria-label="Видео"
        className="flex aspect-video w-full flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-white/10 bg-zinc-900/35 px-4 py-8 text-center md:py-10"
      >
