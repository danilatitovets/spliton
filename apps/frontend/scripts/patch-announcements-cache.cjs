...
const p = path.join(__dirname, "../services/system-announcements.service.ts");
let s = fs.readFileSync(p, "utf8");
if (s.includes("announcementCache")) {
  console.log("already patched");
  process.exit(0);
}

const next = `import { resolveApiUrl } from "@/lib/public-env";
