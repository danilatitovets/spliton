...
const RU: Record<string, string> = {
  ...
  "fees.hero.subtitle":
    "Прозрачные ставки платформы: покупка UNT, secondary market, пополнение и вывод USDT (TRC20) — в одном справочнике.",

  "fees.section.trading": "Торговые комиссии",
  "fees.tabs.navAria": "Разделы комиссий",
  "fees.section.depositWithdrawal": "Ввод и вывод",
  "fees.section.other": "Программы",
  "fees.tab.overview": "Все операции",
  "fees.tab.primary": "Первичный рынок",
  "fees.tab.secondary": "Вторичный рынок",

  "fees.cta.title": "Готовы купить UNT?",
  "fees.cta.subtitle": "Сверьте тарифы и перейдите к каталогу, калькулятору или пополнению баланса.",
  "fees.cta.buy": "Купить",
  "fees.cta.calculator": "Калькулятор",
  "fees.cta.deposit": "Пополнить USDT",

  "fees.visual.eyebrow": "Прозрачность",
  "fees.visual.title": "Тарифы без скрытых удержаний",
  "fees.visual.subtitle":
    "Каждая ставка видна до подтверждения операции. Один справочник для primary, secondary и вывода USDT.",
  "fees.visual.point1": "Комиссия всегда в превью ордера до подписи.",
  "fees.visual.point2": "Одинаковые правила для всех пользователей на уровне KYC.",
  "fees.visual.point3": "История обновлений тарифов — в открытом доступе.",
  ...
  "fees.examples.withdrawalFee": "Комиссия вывода",
...
const EN: Record<string, string> = {
  ...
  "fees.hero.subtitle":
    "Clear platform rates: UNT purchase, secondary market, deposits and USDT (TRC20) withdrawals — in one reference.",

  "fees.section.trading": "Trading fees",
  "fees.tabs.navAria": "Fee sections",
  "fees.section.depositWithdrawal": "Deposit & withdrawal",
  "fees.section.other": "Programs",
  "fees.tab.overview": "All operations",
  "fees.tab.primary": "Primary market",
  "fees.tab.secondary": "Secondary market",

  "fees.cta.title": "Ready to buy UNT?",
  "fees.cta.subtitle": "Review the rates, then open the catalog, calculator, or deposit flow.",
  "fees.cta.buy": "Buy",
  "fees.cta.calculator": "Calculator",
  "fees.cta.deposit": "Deposit USDT",

  "fees.visual.eyebrow": "Transparency",
  "fees.visual.title": "Rates without hidden deductions",
  "fees.visual.subtitle":
    "Every fee is visible before you confirm. One reference for primary, secondary, and USDT withdrawals.",
  "fees.visual.point1": "Fees always appear in the order preview before you sign.",
  "fees.visual.point2": "Same rules for every user at the same KYC level.",
  "fees.visual.point3": "Fee update history is publicly available.",
...
const ES: Record<string, string> = {
  ...
  "fees.hero.subtitle":
    "Tarifas claras de la plataforma: compra de UNT, secondary market, depósitos y retiros USDT (TRC20) — en una sola referencia.",

  "fees.section.trading": "Comisiones de trading",
  "fees.tabs.navAria": "Secciones de comisiones",
  "fees.section.depositWithdrawal": "Depósito y retiro",
  "fees.section.other": "Programas",
  "fees.tab.overview": "Todas las operaciones",
  "fees.tab.primary": "Mercado primario",
  "fees.tab.secondary": "Mercado secundario",

  "fees.cta.title": "¿Listo para comprar UNT?",
  "fees.cta.subtitle": "Revisa las tarifas y abre el catálogo, la calculadora o el depósito.",
  "fees.cta.buy": "Comprar",
  "fees.cta.calculator": "Calculadora",
  "fees.cta.deposit": "Depositar USDT",

  "fees.visual.eyebrow": "Transparencia",
  "fees.visual.title": "Tarifas sin retenciones ocultas",
  "fees.visual.subtitle":
    "Cada comisión se ve antes de confirmar. Una sola referencia para primary, secondary y retiros USDT.",
  "fees.visual.point1": "La comisión siempre aparece en la vista previa del pedido antes de firmar.",
  "fees.visual.point2": "Las mismas reglas para todos los usuarios del mismo nivel KYC.",
  "fees.visual.point3": "El historial de actualización de tarifas es público.",
...
const PT: Record<string, string> = {
  ...
  "fees.hero.subtitle":
    "Tarifas claras da plataforma: compra de UNT, secondary market, depósitos e levantamentos USDT (TRC20) — numa única referência.",

  "fees.section.trading": "Taxas de trading",
  "fees.tabs.navAria": "Secções de taxas",
  "fees.section.depositWithdrawal": "Depósito e levantamento",
  "fees.section.other": "Programas",
  "fees.tab.overview": "Todas as operações",
  "fees.tab.primary": "Mercado primário",
  "fees.tab.secondary": "Mercado secundário",

  "fees.cta.title": "Pronto para comprar UNT?",
  "fees.cta.subtitle": "Confira as tarifas e abra o catálogo, a calculadora ou o depósito.",
  "fees.cta.buy": "Comprar",
  "fees.cta.calculator": "Calculadora",
  "fees.cta.deposit": "Depositar USDT",

  "fees.visual.eyebrow": "Transparência",
  "fees.visual.title": "Tarifas sem retenções ocultas",
  "fees.visual.subtitle":
    "Cada taxa fica visível antes de confirmar. Uma referência para primary, secondary e levantamentos USDT.",
  "fees.visual.point1": "A comissão aparece sempre no preview da ordem antes de assinar.",
  "fees.visual.point2": "As mesmas regras para todos os utilizadores do mesmo nível KYC.",
  "fees.visual.point3": "O histórico de atualizações de tarifas é público.",
