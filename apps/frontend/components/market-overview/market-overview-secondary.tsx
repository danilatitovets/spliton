    ...
    <section className="mx-auto w-full max-w-[1400px] px-4 md:px-6 lg:px-8">
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="font-mono text-[10px] font-semibold font-medium tracking-wide text-zinc-500">
              {t("marketOverview.secondary.title")}
            </h2>
            <p className="mt-1 text-sm font-semibold text-white">{t("marketOverview.secondary.subtitle")}</p>
          </div>
          <span className="rounded-lg bg-[#0a0a0a] px-2 py-0.5 text-[10px] font-medium tracking-wide text-zinc-500">
            USDT
          </span>
        </div>
